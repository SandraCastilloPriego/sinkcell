...
public class Help extends javax.swing.JDialog {
    ...
    public Help(java.awt.Frame parent, boolean modal) {
        ...
        this.jTextArea1.setText("Simple cellular automaton\n\n"
                + "Cellular automaton consist of an infinite number of cells, which have a finite "
                + "number of states. These states change depending on the state of their neighbours. Each cell has the same rule for updating.\n"
                + "\n\nSink\n\n"
    ...
    private void initComponents() {
        ...
        jTextArea1.setMaximumSize(new java.awt.Dimension(260, 75));
